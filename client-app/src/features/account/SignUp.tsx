...
function SignUp() {
  ...
  return (
    <div className="bg-purple-900 absolute top-0 left-0 bg-gradient-to-b from-gray-500 via-gray-500 to-slate-700 bottom-0 leading-5 h-full w-full overflow-hidden">
              ...
              <div className="relative" x-data="{ show: true }">
                ...
                <div className="flex items-center absolute inset-y-0 right-0 mr-3  text-sm leading-5">
                  <svg
                    ...
                    className={
                      "h-4 text-purple-700" + show ? "block" : "hidden"
                    }
                    fill="none"
                  ...
                  <svg
                    onClick={() => setShow(!show)}
                    className={
                      "h-4 text-purple-700" + show ? "hidden" : "block"
                    }
                    fill="none"
                    xmlns="http://www.w3.org/2000/svg"
                    viewBox="0 0 640 512"
